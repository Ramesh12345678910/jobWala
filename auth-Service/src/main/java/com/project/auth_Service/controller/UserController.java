...
public class UserController {
    ...
    public ResponseEntity<?> requestAdmin(@PathVariable Integer userId){
        userService.changePrivilageRequest(userId);
        return new ResponseEntity<>("Your Request Has been Sent Successfully",HttpStatus.OK);
    }

    @PostMapping("/privilage")
    public ResponseEntity<?> changePrivilage(@PathVariable Integer userId){
        return new ResponseEntity<>(userService.updatePrivilage(userId),HttpStatus.OK);
    }
